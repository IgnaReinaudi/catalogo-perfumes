...
function sendWhatsApp(p: Perfume): void {
  const wave = "\uD83D\uDC4B";
  const box  = "\uD83D\uDCE6";
  const msg  = "Hola! Como estas? " + wave + "\n\nMe interesa el perfume " + p.perfume + " de la marca " + p.marca + " que vi en tu catalogo. El precio es USD $" + p.precio + ". Tienen stock? " + box;
      ...
      <div className="p-3 flex flex-col gap-0.5">
        ...
        <div className="flex items-center justify-between gap-1 mt-1">
          ...
          <motion.a
            ...
            className="rounded-full p-1.5 flex items-center justify-center flex-shrink-0 cursor-pointer"
            style={{ background: "#25D366", color: "#ffffff" }}
            onClick={(e) => { e.stopPropagation(); sendWhatsApp(perfume); }}
          >
